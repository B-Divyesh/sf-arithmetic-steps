# Self-guided facilitator checklist
...
1. Open `/` and go to **Use four local checks before classroom use**.
...
4. Use **Reset local checks** to clear the four marks. Marks are not stored
   in browser storage.
